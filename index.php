...
case 'yes':
if (file_exists('content/modul/'.$_GET['opsi'].'/'.$_GET['opsi'].'.php') 
&& !isset($_GET['act']) 
&& !preg_match('/\.\./',$_GET['opsi'])) {
include 'content/modul/'.$_GET['opsi'].'/'.$_GET['opsi'].'.php';
} 	else if (file_exists('content/modul/'.$_GET['opsi'].'/act_'.$_GET['act'].'.php') 
&& !preg_match('/\.\./',$_GET['opsi'])
&& !preg_match('/\.\./',$_GET['act'])
) 
{
include 'content/modul/'.$_GET['opsi'].'/act_'.$_GET['act'].'.php';
} else {
...
include 'content/themes/'.$theme.'/normal.php';
} else if (file_exists('content/'.$_GET['opsi'].'.php') && !preg_match("/\.\./",$_GET['opsi'])){
include 'content/'.$_GET['opsi'].'.php';	
} else {
header("location:index.php");
exit;		
}
...
$tpl = new template ('content/themes/'.$theme.'/'.$theme.'.html');
